...
const Views = {
    ...
    async renderCustomWorkout() {
        ...
        stickyControls.style.position = 'sticky';
        stickyControls.style.top = '0';
        stickyControls.style.zIndex = '10';
        stickyControls.style.background = 'var(--color-bg-primary)';
        stickyControls.style.paddingTop = 'var(--spacing-md)';
        stickyControls.style.paddingBottom = 'var(--spacing-md)';
        stickyControls.style.marginBottom = 'var(--spacing-md)';
        ...
        stickyControls.appendChild(counter);
        ...
        stickyControls.appendChild(actionsContainer);
        ...
        stickyControls.appendChild(startBtn);
        
        content.appendChild(stickyControls);
